...
namespace Tritium.Assets
{
    ...
    public class ScalableFont
    {
        ...
        public static ScalableFont Load(string fontName, string folder = "Fonts/")
        {
            ...
            font.atlasTexture = Texture2D.FromFile(TritiumGame.Instance.GraphicsDevice, atlasPath);
                ...
                foreach (string token in capture.Split('\n'))
                {
                    ...
                    foreach (char c in line)
                    {
                        ...
                        { 
                            ...
                            Quad.Render(
                                TritiumGame.Instance.GraphicsDevice,
        ...
        {
            if (MSDFShader == null)
                MSDFShader = TritiumGame.Instance.Content.Load<Effect>("FieldFontEffect");
        ...
        public void Render(SpriteBatch batch, Matrix? matrix = null)
        {
            ...
            var previousState = TritiumGame.Instance.GraphicsDevice.RasterizerState;
            TritiumGame.Instance.GraphicsDevice.RasterizerState = RasterizerState;
            ...
            TritiumGame.Instance.GraphicsDevice.RasterizerState = previousState;
        }
    }
}
